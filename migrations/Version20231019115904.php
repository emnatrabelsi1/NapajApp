 ...
 */
final class Version20231019115904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE supplier_price DROP updated_at');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE supplier_price ADD updated_at DATETIME NOT NULL');
    }
}
